...
import {playersActions} from '../../stores/slices';
import {useAppDispatch, useAppSelector} from '../../stores/hooks';
// const {CameraModule} = NativeModules;
// const cameraEventEmitter = new NativeEventEmitter(NativeModules.CameraModule);
...
const AllPlayers = () => {
  ...
  const removeItem = (id: number) => {
    disptach(playersActions.removePlayer(id));
  };
  return (
    <View
      style={{
...
const styles = StyleSheet.create({
  ...
  modalInput: {
    ...
    paddingHorizontal: 5,
    borderRadius: 8,
    textAlign: i18next.language === 'en-IR' ? 'right' : 'left',
